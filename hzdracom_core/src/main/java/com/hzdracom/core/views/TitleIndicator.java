...
public class TitleIndicator extends LinearLayout implements View.OnClickListener,
    ...
    protected void add(int index, String label, int icon, boolean hasTips) {
        View tabIndicator;
        if (index < 2) {
            tabIndicator = mInflater.inflate(R.layout.common_views_title_flow_indicator, this, false);
        } else {
            tabIndicator = mInflater.inflate(R.layout.common_views_title_flow_indicator_v2, this, false);
        }
